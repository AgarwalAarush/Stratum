...
test('research packet includes quarterly evidence, SEC filings, and skill-aligned generation rules', async () => {
  ...
  assert.match(source, /policy, macro, supply-chain, or technology environment/)
  ...
  assert.match(source, /Market & Competition must name the relevant market/)
  assert.match(source, /compare 3-5 direct competitors/)
  assert.match(source, /Growth Drivers must rank 3-5 drivers/)
