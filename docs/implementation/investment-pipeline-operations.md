...
- SPY and CompanyPacket peers are fixed at issuance; missing peers are retained and do not silently disappear from the comparison. Peers are company comparables, not a factor-matched portfolio. Stable identities are preserved for recommendations; unresolved benchmark/peer identity and delisting continuity remain data limitations.
