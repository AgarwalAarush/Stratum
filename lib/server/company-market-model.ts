...
function companyMarketModelPrompt(
  ...
  return [
    ...
    'Inventory material named operating assets and capabilities found in primary evidence—such as networks, clusters, data centers, factories, fleets, facilities, installed capacity, or distribution platforms—when they affect customer value, capacity, economics, or strategic optionality. Do not abstract a supported named asset into a generic category when its role is decision-relevant.',
    ...
    'CompanyPacket.marketTheses, when present, are parent market-model context rather than evidence about this company. Test the stated value-chain role independently against CompanyPacket sources. You may disagree, conclude the exposure is immaterial, find that a substitute captures more value, or judge the thesis already priced. Never cite a parent market thesis as a source ID or convert it into a company fact without supporting packet evidence.',
