...
export const ILLUSTRATIVE_MARKET_OVERVIEW: MarketOverviewResponse = {
  ...
  evidence: [
    { id: 'factset', source: 'FactSet Research Systems', publishedAt: '2026-07-15T20:00:00.000Z', url: 'https://www.factset.com/' },
    { id: 'tradeweb', source: 'Tradeweb Markets', publishedAt: '2026-07-15T19:58:00.000Z', url: 'https://www.tradeweb.com/' },
    { id: 'cme', source: 'CME Group', publishedAt: '2026-07-15T19:57:00.000Z', url: 'https://www.cmegroup.com/' },
    { id: 'bloomberg', source: 'Bloomberg News', publishedAt: '2026-07-15T19:51:00.000Z', url: 'https://www.bloomberg.com/' },
    { id: 'morgan-stanley', source: 'Morgan Stanley Research', publishedAt: '2026-07-15T19:45:00.000Z', url: 'https://www.morganstanley.com/what-we-do/research' },
    { id: 'gs', source: 'GS Economics', publishedAt: '2026-07-15T19:32:00.000Z', url: 'https://www.goldmansachs.com/insights/' },
    { id: 'lseg', source: 'LSEG Workspace', publishedAt: '2026-07-15T19:28:00.000Z', url: 'https://www.lseg.com/' },
  ],
  feed: 'illustrative',
  dataAsOf: '2026-07-15T20:00:00.000Z',
  generatedAt: '2026-07-15T20:00:00.000Z',
