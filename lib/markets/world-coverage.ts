...
export const WORLD_COVERAGE_FRONTIERS: WorldCoverageFrontierDefinition[] = [
  { id: 'china-taiwan', label: 'China and Taiwan', description: 'Cross-strait security, US-China competition, industrial policy, trade, and semiconductor dependencies.', queryTerms: ['site:mnd.gov.tw Taiwan Strait military activity', 'site:state.gov Taiwan Strait China policy', 'Taiwan Strait security semiconductor shipping Reuters'], priority: 100, entityTerms: ['taiwan', 'taiwanese', 'taipei'], phrases: ['taiwan strait', 'cross strait'], termGroups: [['china', 'taiwan'], ['china', 'export control'], ['china', 'semiconductor']] },
  ...
  { id: 'political-institutions', label: 'Political institutions', description: 'Authoritarian consolidation, democratic erosion, elections, coups, emergency powers, and civil unrest.', queryTerms: ['site:v-dem.net democracy report authoritarianism', 'site:freedomhouse.org democratic backsliding country report', 'emergency powers election institutions Reuters'], priority: 100, entityTerms: ['authoritarian', 'authoritarianism', 'autocracy', 'autocratic', 'coup'], phrases: ['democratic backsliding', 'emergency powers', 'martial law', 'civil unrest'], termGroups: [['election', 'institution'], ['democracy', 'erosion']] },
  ...
  { id: 'energy-resources-climate', label: 'Energy, resources, and climate', description: 'Energy systems, commodities, critical materials, climate shocks, food, and water constraints.', queryTerms: ['site:noaa.gov ENSO El Nino La Nina outlook', 'site:wmo.int ENSO climate food water risk', 'site:iea.org energy critical minerals supply'], priority: 85, entityTerms: ['enso', 'drought', 'hydropower'], phrases: ['el nino', 'la nina', 'critical minerals', 'climate shock', 'food inflation', 'water stress', 'power grid'], termGroups: [['energy', 'shortage'], ['crop', 'failure']] },
  ...
  { id: 'biotech-clinical-regulatory', label: 'Biotech, clinical, and regulatory', description: 'Clinical trials, regulatory decisions, safety signals, therapeutic platforms, medical meetings, and commercial translation.', queryTerms: ['Phase 3 primary endpoint', 'FDA clinical hold approval', 'biotech trial readout', 'ASCO AACR ESMO late breaking', 'ClinicalTrials.gov material update'], priority: 82, entityTerms: ['FDA', 'ClinicalTrials.gov', 'ASCO', 'AACR', 'ESMO'], phrases: ['primary endpoint', 'clinical hold', 'complete response letter', 'late-stage trial', 'overall survival', 'progression-free survival'], termGroups: [['phase 3', 'endpoint'], ['clinical', 'trial']] },
  { id: 'credit-liquidity-markets', label: 'Credit, liquidity, and markets', description: 'Credit conditions, banking stress, liquidity, positioning, volatility, and market structure.', queryTerms: ['site:bis.org credit liquidity financial stability', 'site:federalreserve.gov financial stability credit conditions', 'site:imf.org global financial stability banking stress'], priority: 80, entityTerms: ['liquidity', 'contagion'], phrases: ['credit conditions', 'banking stress', 'bank failure', 'market structure', 'funding stress'], termGroups: [['credit', 'spread'], ['market', 'volatility']] },
]
